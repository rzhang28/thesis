...
df84cm$Strategy1 <- (df84cm$Viability1 + df84cm$Electability1) / 2
df84cm$Strategy2 <- (df84cm$Viability2 + df84cm$Electability2) / 2
df84cm$Strategy3 <- (df84cm$Viability3 + df84cm$Electability3) / 2
```
...
df84cm[, c("NORMALIZED_STRATEGY1", "NORMALIZED_STRATEGY2",
         "NORMALIZED_STRATEGY3")] <- t(apply(
                df84cm[, c("Strategy1", "Strategy2", "Strategy3")],
...
df84cm[, c("NORMALIZED_FT1", "NORMALIZED_FT2", "NORMALIZED_FT3", 
           "Feeling1", "Feeling2", "Feeling3")]
df84cm[, c("NORMALIZED_STRATEGY1", "NORMALIZED_STRATEGY2", "NORMALIZED_STRATEGY3",
...
df_final %>%
  select(-TRAITS) %>%
  drop_na() %>%
  write.dta("clean_data/df84cm_d_v2.dta")
```
...
df_final %>%
  ...
  ggsave("/Users/ryan/Google Drive/2020_2021/Thesis/Figures/Figure2/anes84_cm_d_strategy.bmp", width = 7.5, height = 4.5)
```
