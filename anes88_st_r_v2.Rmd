...
df88st[, c("NORMALIZED_STRATEGY1", "NORMALIZED_STRATEGY2",
         "NORMALIZED_STRATEGY3", "NORMALIZED_STRATEGY4")] <- t(apply(
                df88st[, c("Strategy1", "Strategy2", "Strategy3", "Strategy4")],
...
df88st[, c("NORMALIZED_STRATEGY1", "NORMALIZED_STRATEGY2", "NORMALIZED_STRATEGY3",
         "NORMALIZED_STRATEGY4", "Strategy1", "Strategy2", "Strategy3", "Strategy4")]
...
df_final %>%
  select(-TRAITS) %>%
  drop_na() %>%
  write.dta("clean_data/df88st_r_v2.dta")
```
...
df_final %>%
  ...
  ggsave("/Users/ryan/Google Drive/2020_2021/Thesis/Figures/Figure2/anes88_st_r_strategy.bmp", width = 7.5, height = 4.5)
```
