...
df_final %>%
  drop_na() %>%
  write.dta("clean_data/df00_super_r_v2.dta")
```
...
df_final %>%
  ...
  ggsave("/Users/ryan/Google Drive/2020_2021/Thesis/Figures/Figure2/naes00_super_r_electability.bmp", width = 7.5, height = 4.5)
...
df_final %>%
  ...
  ggsave("/Users/ryan/Google Drive/2020_2021/Thesis/Figures/Figure2/naes00_super_r_viability.bmp", width = 7.5, height = 4.5)
```
...
df_final_2 %>%
  ...
  mutate(percent = n / sum(n),
         df = "df00_super_r") %>%
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/Figures/Figure3/df00_super_r_counts.csv")
...
df_final_2 %>%
  ...
  mutate(percent = n / sum(n),
         df = "df00_super_r") %>%
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/Figures/Figure3/df00_super_r_counts_aggregate.csv")
```
