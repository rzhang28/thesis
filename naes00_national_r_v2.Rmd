...
df_final %>%
  drop_na() %>%
  write.dta("clean_data/df00_national_r_v2.dta")
```
...
df_final %>%
  ...
  ggsave("/Users/ryan/Google Drive/2020_2021/Thesis/Figures/Figure2/naes00_national_r_strategy.bmp", width = 7.5, height = 4.5)
```
