...
df04 <- naes04 %>%
  ...
  # Traits from cAC06 to cAC11, from cAC18 to cAC23, from cAC27 to cAC32, from
  # cAC36 to cAC41, from cAC45 to cAC50
...
df04[, c("NORMALIZED_IDEOLOGY1", "NORMALIZED_IDEOLOGY2", "Ideology", 
         "Ideology1", "Ideology2")]
df04[, c("TRAITS1", "Cares1", "Inspire1", "Lead1", "Trust1", "Values1", 
         "Know1")]
df04[, c("TRAITS2", "Cares2", "Inspire2", "Lead2", "Trust2", "Values2", 
         "Know2")]
