...
df04[, c("NORMALIZED_FT1", "NORMALIZED_FT2", "NORMALIZED_FT3", "NORMALIZED_FT4", "NORMALIZED_FT5", "NORMALIZED_FT6")] <- t(apply(
  df04[, c("Feeling1", "Feeling2","Feeling3", "Feeling4", "Feeling5",
           "Feeling6")], MARGIN = 1, FUN = my_rescale1))
...
df04[, c("NORMALIZED_VIABILITY1", "NORMALIZED_VIABILITY2", 
         ...
         "NORMALIZED_VIABILITY5", "NORMALIZED_VIABILITY6")] <- t(apply(
           df04[, c("Viability1", "Viability2", "Viability3", 
                    "Viability4", "Viability5", "Viability6")], 
...
df04[, c("NORMALIZED_ELECTABILITY1", "NORMALIZED_ELECTABILITY2", 
         ...
         "NORMALIZED_ELECTABILITY5", "NORMALIZED_ELECTABILITY6")] <- t(apply(
           df04[, c("Electability1", "Electability2", "Electability3", 
                    "Electability4", "Electability5", "Electability6")], 
           MARGIN = 1, FUN = my_rescale2))

# 3) Rescale ideological distance

df04[, c("NORMALIZED_IDEOLOGY1", "NORMALIZED_IDEOLOGY2", "NORMALIZED_IDEOLOGY3", "NORMALIZED_IDEOLOGY4", "NORMALIZED_IDEOLOGY5", 
         "NORMALIZED_IDEOLOGY6")] <- square(
           df04[, c("Ideology1", "Ideology2", "Ideology3", "Ideology4", 
                    "Ideology5", "Ideology6")] - df04[, "Ideology"])

df04[, c("NORMALIZED_IDEOLOGY1", "NORMALIZED_IDEOLOGY2", 
         "NORMALIZED_IDEOLOGY3", "NORMALIZED_IDEOLOGY4", 
         "NORMALIZED_IDEOLOGY5", "NORMALIZED_IDEOLOGY6")] <- t(apply(
           df04[, c("NORMALIZED_IDEOLOGY1", "NORMALIZED_IDEOLOGY2", 
                    "NORMALIZED_IDEOLOGY3", "NORMALIZED_IDEOLOGY4", 
                    "NORMALIZED_IDEOLOGY5", "NORMALIZED_IDEOLOGY6")],
           MARGIN = 1, FUN = my_rescale1))

# 4) Average candidate traits

df04$TRAITS1 = rowMeans(df04[, c("Cares1", "Inspire1", "Lead1", "Trust1", 
                                 "Values1", "Know1")], na.rm = TRUE) / 10
df04$TRAITS2 = rowMeans(df04[, c("Cares2", "Inspire2", "Lead2", "Trust2", 
                                 "Values2", "Know2")], na.rm = TRUE) / 10
df04$TRAITS3 = rowMeans(df04[, c("Cares3", "Inspire3", "Lead3", "Trust3", 
                                 "Values3", "Know3")], na.rm = TRUE) / 10
df04$TRAITS4 = rowMeans(df04[, c("Cares4", "Inspire4", "Lead4", "Trust4", 
                                 "Values4", "Know4")], na.rm = TRUE) / 10
df04$TRAITS5 = rowMeans(df04[, c("Cares5", "Inspire5", "Lead5", "Trust5", "
                                 Values5", "Know5")], na.rm = TRUE) / 10
df04$TRAITS6 = rowMeans(df04[, c("Cares6", "Inspire6", "Lead6", "Trust6", 
                                 "Values6", "Know6")], na.rm = TRUE) / 10
...
df04[, c("NORMALIZED_FT1", "NORMALIZED_FT2", "NORMALIZED_FT3", "NORMALIZED_FT4",
         "NORMALIZED_FT5", "NORMALIZED_FT6", "Feeling1", "Feeling2", "Feeling3", 
         "Feeling4", "Feeling5", "Feeling6")]
df04[, c("NORMALIZED_VIABILITY1", "NORMALIZED_VIABILITY2", 
         "NORMALIZED_VIABILITY3", "NORMALIZED_VIABILITY4", 
         "NORMALIZED_VIABILITY5", "NORMALIZED_VIABILITY6", 
         "Viability1", "Viability2", "Viability3", 
         "Viability4", "Viability5", "Viability6")]
df04[, c("NORMALIZED_ELECTABILITY1", "NORMALIZED_ELECTABILITY2", 
         "NORMALIZED_ELECTABILITY3", "NORMALIZED_ELECTABILITY4", 
         "NORMALIZED_ELECTABILITY5", "NORMALIZED_ELECTABILITY6", 
         "Electability1", "Electability2", "Electability3", 
         "Electability4", "Electability5", "Electability6")]
df04[, c("NORMALIZED_IDEOLOGY1", "NORMALIZED_IDEOLOGY2", "NORMALIZED_IDEOLOGY3",
         "NORMALIZED_IDEOLOGY4", "NORMALIZED_IDEOLOGY5", "NORMALIZED_IDEOLOGY6", 
         "Ideology1", "Ideology2", "Ideology3", 
         "Ideology4", "Ideology5", "Ideology6")]
df04[, c("TRAITS1", "Cares1", "Inspire1", "Lead1", 
         "Trust1", "Values1", "Know1")]
df04[, c("TRAITS2", "Cares2", "Inspire2", "Lead2", 
         "Trust2", "Values2", "Know2")]
df04[, c("TRAITS3", "Cares3", "Inspire3", "Lead3", 
         "Trust3", "Values3", "Know3")]
df04[, c("TRAITS4", "Cares4", "Inspire4", "Lead4", 
         "Trust4", "Values4", "Know4")]
df04[, c("TRAITS5", "Cares5", "Inspire5", "Lead5", 
         "Trust5", "Values5", "Know5")]
df04[, c("TRAITS6", "Cares6", "Inspire6", "Lead6", 
         "Trust6", "Values6", "Know6")]
