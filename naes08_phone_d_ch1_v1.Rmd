...
# strength, political interest,  / political efficacy
...
df_final_temp <- data.frame(df_final_temp, value=TRUE)
...
df_final_temp_2 <- data.frame(df_final_temp, value=TRUE)

df_final_temp_2 <- df_final_temp_2 %>%
  arrange(WC03_c) %>%
  reshape(idvar = c("ID", "Candidate", "VoteCandidate", "NORMALIZED_FT", "NORMALIZED_VIABILITY", 
                    "NORMALIZED_ELECTABILITY", "NORMALIZED_IDEOLOGY", 
...
df_final_temp_2[is.na(df_final_temp_2)] <- 0

# Gender

df_final_temp_3 <- data.frame(df_final_temp_2, value=TRUE)

df_final_temp_3 <- df_final_temp_3 %>%
  arrange(WA01_c) %>%
  reshape(idvar = c("ID", "Candidate", "VoteCandidate", "NORMALIZED_FT", "NORMALIZED_VIABILITY", 
                    "NORMALIZED_ELECTABILITY", "NORMALIZED_IDEOLOGY", 
                    "TRAITS", "CLINTON", "EDWARDS", "OBAMA", "WA02_c", "WA04_c", 
...
df_final_temp_3[is.na(df_final_temp_3)] <- 0

# Party ID strength

df_final_temp_4 <- data.frame(df_final_temp_3, value=TRUE)

df_final_temp_4 <- df_final_temp_4 %>%
  arrange(MA02_c) %>%
...
df_final_temp_4[is.na(df_final_temp_4)] <- 0

# Political interest

df_final_temp_5 <- data.frame(df_final_temp_4, value=TRUE)

df_final_temp_5 <- df_final_temp_5 %>%
  arrange(KA01_c) %>%
...
df_final_temp_5[is.na(df_final_temp_5)] <- 0
  
df_final_temp_5 %>%
  drop_na() %>%
  write.dta("clean_data/df08phone_d_v3.dta")
```
